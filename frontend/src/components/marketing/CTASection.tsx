...
import { useCTASection } from "@/lib/admin/use-site-content";
          ...
          <div className="relative z-10 px-8 py-16 md:px-16 md:py-24 text-center">
            ...
            >
              ...
              <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-foreground mb-8 leading-tight tracking-tight">
                {cta.title} <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">{cta.titleAccent}</span>
              </h2>
